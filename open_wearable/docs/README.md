...
- [App Upgrade Highlights](./app-upgrade-highlights.md)
  - How the post upgrade "What's New" framwork works and how to customize it per release.
...
3. [App Upgrade Highlights](./app-upgrade-highlights.md)
