  ...
  AppInfo(
   ...
   AppInfo(
    ...
    widget: SelectTwoEarableView(
      startApp: (leftWearable, leftProv, rightWearable, rightProv) {
        return StrokeTrackerView(
          leftManager: leftWearable as SensorManager,
          rightManager: rightWearable as SensorManager,
        );
      },
    ),
    ),
