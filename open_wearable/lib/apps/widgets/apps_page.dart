...
final List<AppSupportOption> _postureSupportedDevices = [
  AppSupportOption(
    label: "Accelerometer",
    requirement: AppRequirement.hasSensorByAliases(accelerometerSensorAliases),
  ),
];
...
final List<AppSupportOption> _studyProtocolSupportedDevices = [
  ...
  AppSupportOption(
    label: "PLUX RespiBAN",
    requirement: AppRequirement.custom((wearable) => wearable is Respiban),
  ),
];
