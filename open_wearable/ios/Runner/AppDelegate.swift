...
@objc class AppDelegate: FlutterAppDelegate {
  ...
  override func application(
    ...
    let systemSettingsChannel = FlutterMethodChannel(name: "edu.kit.teco.openwearables/system_settings", binaryMessenger: controller.binaryMessenger)
    lifecycleChannel = FlutterMethodChannel(name: "edu.kit.teco.openwearables/lifecycle", binaryMessenger: controller.binaryMessenger)
